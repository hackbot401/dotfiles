...
pacman -S --noconfirm xmonad xmonad-contrib xmobar alacritty kitty xorg-server xorg-xinit xorg-xkill xorg-xsetroot xorg-xbacklight xorg-xprop \
...
git clone https://github.com/hackbot401/dotfiles.git
cd dotfiles
cp -r .xmonad ~/.xmonad
cp -r config/* ~/.config/
